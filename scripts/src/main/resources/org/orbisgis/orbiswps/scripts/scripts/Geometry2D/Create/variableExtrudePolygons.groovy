...
def processing() {
	...
	def query = "CREATE TABLE ${outputTableName} AS SELECT ST_EXTRUDE(${geometricField[0]},${height[0]}) AS the_geom "
...
@JDBCColumnInput(
		...
		description = "A numeric column to specify the height of the polygon.",
        jdbcTableReference = "inputTable",
