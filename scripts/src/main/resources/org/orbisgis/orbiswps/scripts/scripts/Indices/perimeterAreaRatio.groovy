...
@Process(
    title = [
				"Perimeter-Area Ratio","en",
				"Ratio périmètre/surface","fr"],
    description = [
				"Perimeter-area ratio is a measure of shape complexity.It equals the ratio of the perimeter to area.<p><em>Bibliography:</em></p>","en",
				"Calcule le ration entre le périmètre et la surface d'un polygon pour exprimer une complexité de forme.<p><em>Bibliographie:</em></p>","fr"],
...
def processing() {
    ...
    String  outputTable = inputTable+"_perimeterAreaRatio"
    ...
    query += idField[0]+","+ "ST_PERIMETER ("+ geometryColumn[0] +")  / ST_AREA ("+ geometryColumn[0] +")  as perimeterarearatio from " +  inputTable
