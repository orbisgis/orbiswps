...
public class TestWPS_1_0_0_Execute {
    ...
    public void testFullProcessResponseDocumentExecute(){
        ...
        complexDataType.getOtherAttributes().put(new QName("String"), "enumeration");
        ...
        assertEquals("The 'serviceInstance' property of ExecuteResponse should be set to ''", "",
                executeResponse.getServiceInstance());
        ...
        assertEquals("The 'processOutputs' property of ExecuteResponse should contains only one value",
        ...
        for(OutputDataType outputDataType : executeResponse.getProcessOutputs().getOutput()){
            ...
            if(type.startsWith("jdbc")){
                type = type.substring(0, 4).toUpperCase() + type.substring(4);
            }
            ...
            switch(type){
                ...
                case "Password" :
                    ...
                    assertTrue("The 'data' 'complexData' 'otherAttributes' property of OutputDataType should contains '"+type+"'",
                            outputDataType.getData().getComplexData().getOtherAttributes().containsValue(type));
                    break;
                case "LiteralDataDouble" :
                    ...
                    assertEquals("The 'data' 'literalData' 'dataType' property of OutputDataType should be set to '10.0'",
                ...
                case "LiteralDataString" :
                    ...
                    assertFalse("The 'data' 'literalData' 'dataType' property of OutputDataType should not be set",
                            outputDataType.getData().getLiteralData().isSetDataType());

                    assertTrue("The 'data' 'literalData' 'dataType' property of OutputDataType should be set",
                            outputDataType.getData().getLiteralData().isSetValue());
                    assertEquals("The 'data' 'literalData' 'dataType' property of OutputDataType should be set to '"+type+"'",
    ...
    //test request two output with responseDocument
    //test each status
    //minimal execute
